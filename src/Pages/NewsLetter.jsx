    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-center">
                ...
                <img className="w-14 h-14" src="https://i.ibb.co/KDJk7H5/pngtree-rocket-logo-design-png-image-4032269.jpg" alt="" />
            </div>
            ...
            <form onSubmit={handleSubscribe} className="flex items-center justify-center gap-3">
                ...
                <button  className="bg-blue-500 text-white rounded-md px-4 py-2 lg:w-1/6">Subscribe</button>
